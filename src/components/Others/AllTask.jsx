  ...
  if (selectedEmployee) {
    return (
      <EmployeeDashboard
        ...
        goBack={() => setSelectedEmployee(null)} // Add goBack function
      />
    );
  }

  return (
    <div id="tasklist" className="mt-5 mb-5 w-full rounded-xl bg-white/10 border border-white/40 text-white backdrop-blur-md font-semibold tracking-wide shadow-lg hover:shadow-[0_0_10px_teal] transition-shadow p-5">
      ...
      {filteredEmployees.map((employee) => {
        ...
        return (
          <div
            key={employee.name}
            onClick={() => setSelectedEmployee(employee)} // Set selected employee
